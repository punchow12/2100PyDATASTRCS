...
if __name__ == '__main__':
    ...
    mostcommonword = most_frequent_word(hist)
    print('The most frequently occurring word is:', mostcommonword[0])
    print('# of occurrences: ', mostcommonword[1])
