...
class LinkedDeque:
    ...
    def _insert_before(self, node: 'LinkedDeque._Node', x: any) -> None:
        ...
        """
        # Base Cases: Deque is empty, Deque is not empty, appended at the end of deque
    ...
    def append(self, x: any) -> None:
        ...
        if (len(self) == 0):
            ...
            # tail node is new node
            new_node.next = self._dummy
            self._dummy.prev = new_node
            self._num_items += 1

            #raise NotImplementedError("append hasn't been implemented.")
    ...
    def popleft(self) -> any:
        ...
        #self._dummy.next.prev = self._dummy
        #self._num_items -= 1
        if len(self) == 0:
            return None
        else:
